...
class RawInferenceOutput {
  ...
  /// Optional flat float32 output values from the secondary household model.
  final List<double>? householdData;

  /// Optional shape of the secondary household output tensor, e.g. [1, 605, 2100].
  final List<int>? householdOutputShape;
