...
- Keep Raspberry Pi UI visually consistent while representing the implemented
  local Wearable state machine truthfully; never imply cloud or frame streaming.
